...
public class Test_GradeEstimator {
	...
	public static void main( String[] args ) {
		...
		//Runs program with a the sample grade_info2.txt
		test("test04 Grade File Exists", "grade_info2.txt", "Letter Grade Estimate: C");
		...
		test("test05 Grade File Exists", "grade_info_ex.txt", "Letter Grade Estimate: C");

		test("test06 Grade File Exists", "grade_info_ex1.txt", "Letter Grade Estimate: B");
